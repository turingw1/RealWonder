...
def main():
    ...
    global preview_b64, default_prompt, case_name, num_blocks, experiment_log_dir
    ...
    with bootstrap_logger.time_block("demo.startup.initialize_video_generator"):
    ...
    with bootstrap_logger.time_block("demo.startup.initialize_simulator"):
    ...
    with bootstrap_logger.time_block("demo.startup.initialize_case_handler"):
    ...
    with bootstrap_logger.time_block("demo.startup.initialize_noise_warper"):
    ...
    with bootstrap_logger.time_block("demo.startup.precompute_first_frame"):
    ...
    bootstrap_logger.finalize(status="completed")
